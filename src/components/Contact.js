        ...
        <div className="-mx-4 flex flex-wrap lg:justify-between gap-3">
          <div className="w-full px-4 lg:w-1/2 xl:w-6/12 bg-white">
            <div className="mb-12 max-w-[570px] lg:mb-0">
              ...
              <h2 className="text-dark text-center mb-6 text-[32px] font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px]">
              ...
              <div className="mb-8 flex w-full max-w-[370px]">
                <div className="bg-orange-400 text-orange-400 mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
              ...
              <form>
                <div className="mb-6">
                  <input
                    ...
                    className="text-body-color border-[f0f0f0] focus:border-orange-400 w-full rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none"
                  />
                </div>
                <div className="mb-6">
                  <input
                ...
                <div className="mb-6">
                  <textarea
                    ...
                    className="text-body-color border-[f0f0f0] focus:border-orange-400 w-full resize-none rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none"
                  ></textarea>
                </div>
                <div>
                  <button
                    type="submit"
                    className="bg-orange-400 border-orange-400 w-full rounded border p-3 text-white transition hover:bg-opacity-90"
                  >
                    Send Message
                  </button>
                </div>
